package com.finalproject.exerciseunittest
...
import com.finalproject.exerciseunittest.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    fun validationName(name: String): Boolean{
        if ("farhan".equals(name)){
            Toast.makeText(this,"nama sama",Toast.LENGTH_SHORT).show()
            return true
        }else{
            Toast.makeText(this,"nama tidak sama",Toast.LENGTH_SHORT).show()
            return false
        }
    }
}